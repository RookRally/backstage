...
# This switches many Node.js dependencies to development mode.
...
# To make sure we are not running Docker in Docker for the deployment
RUN echo "techdocs:" >> app-config.deployment.yaml
